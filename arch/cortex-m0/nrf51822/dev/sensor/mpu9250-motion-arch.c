...
#include "dev/sensor/inv_mpu/inv_mpu_dmp_motion_driver.h"
#include "dev/sensor/inv_mpu/mllite/invensense.h"
#include "dev/sensor/inv_mpu/mpl/invensense_adv.h"
#include "dev/sensor/inv_mpu/eMPL-hal/eMPL_outputs.h"
#include "dev/sensor/inv_mpu/include/mltypes.h"
#include "dev/sensor/inv_mpu/include/mpu.h"
...
/*---------------------------------------------------------------------------*/
int
mpu9250_arch_init(motionfusion_config_t *config)
{
  ...
  // spi_master_config_t spi_config;
	// spi_config.freq =  SPI_FREQUENCY_M4;
	// spi_config.sck_pin = MPU_SCL;
	// spi_config.mosi_pin = MPU_SDA;
	// spi_config.miso_pin = MPU_AUX;
	// spi_config.irq_priority = 6;
	// spi_config.order = SPI_MSB;
	// spi_config.mode = SPI_MODE0;
  // spi_config.cs_pin = MPU_CS;
	// spi1_driver.init(&spi_config);
