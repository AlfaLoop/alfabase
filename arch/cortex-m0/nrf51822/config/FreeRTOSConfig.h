 ...
 *----------------------------------------------------------*/
   ...
   #error Non-defined FREERTOS_TOTAL_HEAP_SIZE_CONF in bsp_init.h
 #endif

 #if !defined(FREERTOS_MAX_PRIORITY_CONF)
   #error Non-defined FREERTOS_MAX_PRIORITY_CONF in bsp_init.h
 #endif

 #if !defined(FREERTOS_TIMER_TASK_PRIORITY_CONF) || !defined(FREERTOS_CONTIKI_TASK_PRIORITY_CONF)
   #error Non-defined FREERTOS_TIMER_TASK_PRIORITY_CONF and FREERTOS_CONTIKI_TASK_PRIORITY_CONF in bsp_init.h
 #endif

 #if !defined(FREERTOS_APP_TASK_PRIORITY_CONF) || !defined(FREERTOS_APP_IRQ_TASK_PRIORITY_CONF)
   #error Non-defined FREERTOS_APP_TASK_PRIORITY_CONF and FREERTOS_APP_IRQ_TASK_PRIORITY_CONF in bsp_init.h
 #endif
