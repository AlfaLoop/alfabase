...
#if !defined(FREERTOS_TOTAL_HEAP_SIZE_CONF)
  #error Need defined FREERTOS_TOTAL_HEAP_SIZE_CONF in bsp_init.h
#endif

#if !defined(FREERTOS_MAX_PRIORITY_CONF)
  #error Need defined FREERTOS_MAX_PRIORITY_CONF in bsp_init.h
#endif

#if !defined(FREERTOS_TIMER_TASK_PRIORITY_CONF) || !defined(FREERTOS_CONTIKI_TASK_PRIORITY_CONF)
  #error Need defined FREERTOS_TIMER_TASK_PRIORITY_CONF and FREERTOS_CONTIKI_TASK_PRIORITY_CONF in bsp_init.h
#endif

#if !defined(FREERTOS_APP_TASK_PRIORITY_CONF) || !defined(FREERTOS_APP_IRQ_TASK_PRIORITY_CONF)
  #error Need defined FREERTOS_APP_TASK_PRIORITY_CONF and FREERTOS_APP_IRQ_TASK_PRIORITY_CONF in bsp_init.h
#endif
...
#define configMAX_PRIORITIES			( FREERTOS_MAX_PRIORITY_CONF )
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 96 )
#define configTOTAL_HEAP_SIZE			FREERTOS_TOTAL_HEAP_SIZE_CONF
...
#define configTIMER_TASK_PRIORITY                 ( FREERTOS_TIMER_TASK_PRIORITY_CONF )
...
#define xPortHardFaultHandler             HardFault_Handler
// #define xPortUsageFaultHandler             UsageFault_Handler
// #define xPortMemManageHandler             MemManage_Handler
// #define xPortBusFaultHandler             BusFault_Handler
