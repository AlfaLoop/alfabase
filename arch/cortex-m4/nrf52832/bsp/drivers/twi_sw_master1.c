...
bool twi_master1_init(uint32_t sda_pin, uint32_t sck_pin)
{
...
bool twi_master1_transfer(uint8_t address, uint8_t * data, uint8_t data_length, bool issue_stop_condition)
{
