...
/*---------------------------------------------------------------------------*/
static int
spi2_init(spi_master_config_t *config)
{
	uint32_t errcode;
  ...
  | (GPIO_PIN_CNF_SENSE_Disabled    << GPIO_PIN_CNF_SENSE_Pos);
	...
	NRF_SPI_Type * p_spi = (NRF_SPI_Type *) NRF_SPI2;
...
/*---------------------------------------------------------------------------*/
static int
spi2_transfer(uint8_t * const p_tx_buf, const uint16_t tx_buf_len,
...
/*---------------------------------------------------------------------------*/
const struct spi_driver spi2_driver = {
	"spi2 driver",
	spi2_init,
	spi2_enable,
	spi2_disable,
